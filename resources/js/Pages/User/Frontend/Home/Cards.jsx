        ...
        <section className="relative px-4 font-['Poetsen_One'] sm:px-6 md:px-8 lg:px-10">
            <div className="container mx-auto">
                <div className="my-4 flex items-center justify-center">
                    <div className="w-[180px] md:w-[200px] border-b-4 border-white pb-3 md:pb-4 flex justify-center items-center gap-3">
                        <img src={shop?.image} className="w-12 h-12 rounded-full object-fill" alt="" />
                        <span className="text-4xl font-[400] tracking-[-1px] text-[#ffffff] sm:text-[48px] sm:tracking-[-2px] md:text-[63px]">{shop?.name}</span>
                    </div>
                </div>

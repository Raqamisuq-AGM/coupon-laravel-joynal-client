            ...
            <div className="card mx-auto w-full max-w-md">
                <form onSubmit={submit} className="card-body px-10 py-12">
                    ...
                    <div className="mt-6 flex flex-col gap-5">
                        {/* Email */}
                        <InputGroup label="Email Or Phone" name="username" formObject={data} setFormObject={setData} validationError={errors}/>

                        {/* Password */}
                        <InputGroup label="Password" name="password" formObject={data} setFormObject={setData} validationError={errors}/>
                    </div>
                    {/* Remember & Forgot*/}
                    ...
                    {/* Login Button */}
                    <div className="mt-8">
                        <PrimaryButton type="submit" className="w-full"  isLoading={processing} >Login</PrimaryButton>
                        ...
                        <button type='button' className="btn btn-outline-primary mt-4 w-full gap-3 py-2">
                    ...
                    <div className="mt-4 flex justify-center">
                        ...
                        Don't Have an Account?
                        <a href="#" className="text-sm text-primary-500 hover:underline">Sign up</a>
                        </p>
                    </div>
                </form>
            </div>
